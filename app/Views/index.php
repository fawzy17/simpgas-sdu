...
<head>
    ...
    <!--====== Title ======-->
    <title>SIMPGAS - SDU</title>

    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="<?= base_url('assets/consult/images/favicon.png" type="image/png'); ?>">
...
<body>
  ...
  <![endif]-->
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="<?= base_url('assets/consult/images/logo.png'); ?>" alt="Logo">
                            </a>
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn" href="<?= base_url('/auth/login'); ?>">Sign In</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url<?= base_url('assets/consult/images/header-hero.jpg') ?>);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="header-hero-content">
                            ...
                            <div class="header-singup wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
                                <input id="email" name="email" type="text" placeholder="username@yourdomain.com" autocomplete="email">
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="1.1s">
                <div class="image">
                    <img src="<?= base_url('assets/consult/images/hero-image.png'); ?>" alt="Hero Image">
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="<?= base_url('assets/consult/images/about.png'); ?>" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="<?= base_url('assets/consult/images/our-service-1.jpg'); ?>" alt="service">
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="<?= base_url('assets/consult/images/service-1.png'); ?>" alt="Icon">
                            </div>
                            ...
                            <div class="shape shape-1">
                                <img src="<?= base_url('assets/consult/images/shape/shape-1.svg'); ?>" alt="shape">
                            </div>
                            <div class="shape shape-2">
                                <img src="<?= base_url('assets/consult/images/shape/shape-2.svg'); ?>" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service service-border d-flex">
                            <div class="service-icon">
                                <img src="<?= base_url('assets/consult/images/service-2.png'); ?>" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-3">
                                <img src="<?= base_url('assets/consult/images/shape/shape-3.svg'); ?>" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="<?= base_url('assets/consult/images/service-3.png'); ?>" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-4">
                                <img src="<?= base_url('assets/consult/images/shape/shape-4.svg'); ?>" alt="shape">
                            </div>
                            <div class="shape shape-5">
                                <img src="<?= base_url('assets/consult/images/shape/shape-5.svg'); ?>" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="<?= base_url('assets/consult/images/protfolio-1.jpg'); ?>" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="<?= base_url('assets/consult/images/protfolio-1.jpg'); ?>">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="<?= base_url('assets/consult/images/protfolio-2.jpg'); ?>" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="<?= base_url('assets/consult/images/protfolio-2.jpg'); ?>">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="<?= base_url('assets/consult/images/protfolio-3.jpg'); ?>" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="<?= base_url('assets/consult/images/protfolio-3.jpg'); ?>">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="<?= base_url('assets/consult/images/protfolio-5.jpg'); ?>" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="<?= base_url('assets/consult/images/protfolio-5.jpg'); ?>">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="<?= base_url('assets/consult/images/protfolio-4.jpg'); ?>" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="<?= base_url('assets/consult/images/protfolio-4.jpg'); ?>">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="<?= base_url('assets/consult/images/protfolio-6.jpg'); ?>" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="<?= base_url('assets/consult/images/protfolio-6.jpg'); ?>">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="<?= base_url('assets/consult/images/author-1.jpg'); ?>" alt="author">
                                        </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="<?= base_url('assets/consult/images/author-2.jpg'); ?>" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="<?= base_url('assets/consult/images/author-3.jpg'); ?>" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
    ...
    <section id="contact" class="contact-area pt-120 pb-20">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-1 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">Kampung Cimahi Rt 007 Rw 004, Desa Sukamahi Kecamatan Cikarang Pusat, Sukamahi, Kec. Cikarang Pusat, Kabupaten Bekasi, Jawa Barat 17530</p>
                            </div>
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url<?= base_url('assets/consult/images/footer-bg.jpg)'); ?>">
        <div class="container">
